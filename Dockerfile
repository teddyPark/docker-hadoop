...
# install dev tools
RUN yum -y install sudo openssh-server openssh-clients rsync netstat wget
...
RUN curl -s http://mirror.23media.de/apache/hadoop/common/hadoop-2.7.3/hadoop-2.7.3.tar.gz | tar -xz -C /usr/local/
